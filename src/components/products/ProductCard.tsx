              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <button 
                    ...
                    className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center border border-white/10 hover:bg-accent hover:border-transparent hover:shadow-[0_0_20px_var(--accent)] transition-all z-20"
                  >
